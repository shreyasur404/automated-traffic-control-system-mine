...
class TrafficControlApp:
    def __init__(self, root):
        self.root = root
        self.root.title("Automated Traffic Management System")
    ...
    def setup_ui(self):
        ...
        title_label = ttk.Label(title_frame, text="Automated Traffic Management System", style='Title.TLabel')
...
The lane with the highest Total Priority gets the green light.
    ...
    def create_decision_explanation_tab(self, notebook, green_lane, priorities):
        ...
        if green_lane:
            ...
            decision_text = "No decision made"
            decision_summary = "Insufficient data to make a traffic control decision."
